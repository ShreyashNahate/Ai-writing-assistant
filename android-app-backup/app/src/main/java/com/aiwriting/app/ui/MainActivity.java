...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.loadUsage();
        // Auto-start overlay service if permission granted
        if (Settings.canDrawOverlays(this)) {
            startService(new Intent(this, FloatingOverlayService.class));
            sessionManager.setOverlayEnabled(true);
        }
        Log.e("AI_DEBUG", "canDrawOverlays=" + Settings.canDrawOverlays(this));
        Log.e("AI_DEBUG", "isOverlayEnabled=" + sessionManager.isOverlayEnabled());
    }
